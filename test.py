...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', type=str, default='snapshots/CAF_B/FAFuse-22.pth')
    ...
    model = CAF_B(ring_radius=[12, 16, 16], ring_width=[2, 4, 8]).cuda()

    dummy_input = torch.randn(1, 3, 384, 384).to('cuda:0')
